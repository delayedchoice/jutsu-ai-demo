...
(defn mnist-train []
  (let [mnist-training-iterator (ai/classification-image-parent-dir-labeled-iterator "resources/mnist/training" 28 28 1 128 10 123)
        mnist-testing-iterator (ai/classification-image-parent-dir-labeled-iterator "resources/mnist/test" 28 28 1 128 10 123) ]
     (-> mnist-net
